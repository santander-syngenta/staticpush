...
from (select UAV.trial_id,													
		...
		from (select distinct trial_arm as trial_id, 											
		                ...
		                where uav_raw.trial_arm =  'USNB0H1232021' --'USNH0T0692020'											
		                and uav_raw.data_output is not null and plot_num is not null											
		                and plot_type = 'TRT'  --decided to eliminate CHK data May 2022 because it is just for calibations											
		                ) UAV 											
